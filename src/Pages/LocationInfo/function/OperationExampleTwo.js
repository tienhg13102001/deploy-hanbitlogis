...
class OperationExample extends Component {
    list = [
        { text: '인건비', text2: '1,560,00 원', text3: '1,381,250 원', text4: '기본금, 상여금, 퇴직적립금, 월차수당포함' },
        { text: '복리후생비', text2: '240,200 원', text3: '200,175 원', text4: '고용, 의료, 국민, 산재보험' },
        { text: '보험료', text2: '209,600 원', text3: '146,200 원', text4: '직영 : 업무용 (책임, 종합)', text5: '위탁 : 영업용 (책임, 종합)' },
        { text: '공과금', text2: '18,000 원', text3: '8,500 원', text4: '자동차, 환경개선부담금, 검사비, 면허세', text5: '직영 (업무용), 위탁 (영업용)' },
        { text: '정기보수비', text2: '196,000 원', text3: '196,000 원', text4: '전국 동종 업계 비교' },
        { text: '감가상각·금융비', text2: '768,500 원', text3: '768,500 원', text4: '차량가기준' },
