...
class AnalysisType extends Component {
    list1 = [
        { text: 'DRY (건조화물)', text2: '전자제품, 의약품 일부, 플라스틱, 목재류', text3: '카고, 탑차, 윙바디 등' },
        { text: 'WET (습기화물)', text2: '유제품, 의약품, 냉동, 냉동식품, 채소, 과일 등 일정 온도 유지가 필요한 제품', text3: '냉동 탑차', },
        { text: '특수보존화물', text2: '화학물질, 의류, 유리 제품 등', text3: '해당 규모 특장차' }
    ]

    list2 = [
        { text: '카고', text2: '전자제품, 의약품 일부, 플라스틱, 목재류' },
        { text: '내장탑', text2: '유제품, 의약품, 냉동, 냉장식품, 채소, 과일 등 일정 온도 유지가 필요한 제품' },
        { text: '냉장탑', text2: '화학물질, 의류, 유리, 제품 등' },
        { text: '윙바디', text2: '차량 화물칸이 양 쪽으로 개폐 가능하여 지게차를 이용 상, 하차 작업이 가능하며, 보통 5톤 이상 화물차 물류센터 ~센터, 물류창고 ~중간 집하장에 주로 이용' },
        { text: '리프트탑', text2: '차종은 내장탑과 카고와 동일하며 단지 무거운 단일 제품의 상, 하차에 사용하기 위해 부가적으로 탑재한 화물차' },
        { text: '탱크로리', text2: '유조차, LPG 운반차, 화학물 운반차 등 유류나 가스 등 특수 화물 운반에 사용되는 특수목적차량' },
        { text: 'VAN', text2: '승합체와 승용차에서 뒷칸 부분을 짐칸 전용으로 만든 차량으로 현금 수송, 유가증권수송, 택배, 퀵서비스 의학품 배송 등에 주로 사용' },
    ]
