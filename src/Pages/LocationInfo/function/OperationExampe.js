...
class OperationExample extends Component {
    list = [
        ...
        { text: '보험료', text2: '144,700 원', text3: '124,700 원', text4: '직영 : 업무용 (책임, 종합)', text5: '위탁 : 영업용 (책임, 종합)' },
        { text: '공과금', text2: '10,700 원', text3: '5,000 원', text4: '자동차, 환경개선부담금, 검사비, 면허세', text5: '직영 (업무용), 위탁 (영업용)' },
        { text: '정기보수비', text2: '177,000 원', text3: '177,000 원', text4: '전국 동종 업계 비교' },
        { text: '감가상각·금융비', text2: '497,500 원', text3: '497,500 원', text4: '차량가기준' },
