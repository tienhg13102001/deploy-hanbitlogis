...
class AnalysisResult extends Component {
    list = [
        { title:'원가절감으로 기업 경쟁력 향상', number:'01', text:'· 초기 차량 구입시 자금 압박 해소 (제세금 및 공과금)', text2:'· 고정지출비절감, 감가상각비, 유지관리비 해소 (월정 지입료만 지출)', text3:'· 자연 및 주변 환경에 대한 책임 해소 (화물의 파손 및 도난)', text4:'· 차량 및 인적 사고에 대한 책임 해소'},
