...
class HistoryContents extends Component {
    list = [
        ...
        { year:'1999년', month:'05월', text:'주식회사 한빛특송 설립'},
        { year:'1998년', month:'05월', text:'협력사별 50 - 100평 창고 2개 보유'},
        { year:'1997년', month:'05월', text:'21세기 종합물류 주식회사 창립'},
                    ...
                    {this.list.map((item, index) => {
                        return (
                            <div className="List_Box" key={index}>
                                ...
                                <div className="Box_Text">{item.text}{item.text2}</div>
                            </div>
                        )
                    })}
                </div>
