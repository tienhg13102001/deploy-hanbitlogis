...
class Hanbit extends Component {
    list = [
        { id: 0, text: '당사는 최고의 물류 전문 회사 한빛로지스 국토부장관상 수상', date: '2022.04.11' },
        { id: 1, text: '한빛로지스 국토부장관상 수상! 당사는 최고의 물류 전문 회사입니다.', date: '2022.04.11' },
        { id: 2, text: '한빛로지스는 향상된 서비스를 제공할 것을 약속드립니다.', date: '2022.04.11' },
